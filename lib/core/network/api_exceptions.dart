...
class ApiExceptions {
  static ApiError handleError(DioException error) {
    ...
    if (statusCode == 302) {
      throw ApiError(message: 'This Email Already Taken302');
    }
    if (statusCode == 429) {
      throw ApiError(message: 'This Email Already Taken429');
    }
    if (statusCode == 422) {
      throw ApiError(message: 'The password field must be at least 8 characters.');
    }
    if (statusCode == 500) {
